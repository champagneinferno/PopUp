...
│   └── components/
│       ├── CameraAnimator.jsx   # Scroll-driven camera + section visuals
│       ├── Model.jsx            # glTF loader + PBR materials
│       ├── Loader.jsx           # Loading screen with progress bar
│       └── ...                  # SceneController, Particles, etc.
...
- Section visual blending
- OrbitControls sync

**Customize**: `SECTIONS` array (camera positions) and `SECTION_VISUALS` (per-section transforms)
